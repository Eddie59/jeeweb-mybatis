...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${adminPath}/main" frameborder="0"
                    data-id="${adminPath}/main" seamless></iframe>
        </div>
        <div class="footer">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <br>
                                        <small class="text-muted"><fmt:formatDate value="${oaNotification.createDate}"
                                                                                  pattern="yyyy-MM-dd HH:mm:ss"/></small>
                                    </div>
                                </a>
                            </div>
