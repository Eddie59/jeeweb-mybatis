...
public class DataGridTag extends AbstractGridHtmlTag {
	...
	private List<Map<String, Object>> buttonList = new ArrayList<Map<String, Object>>();// 行内按钮组
	private List<Map<String, Object>> queryList = new ArrayList<Map<String, Object>>();//查询
	...
	public int doStartTag() throws JspException {
		...
		System.out.println("DataGridTag类的doStartTag方法");
	...
	//待grid标签和它的子标签都初始化完以后，grid标签会调用doEndTag方法，
	//使用Freemarker把准备好的“标签数据”填到模版里，然后write到页面
	@Override
