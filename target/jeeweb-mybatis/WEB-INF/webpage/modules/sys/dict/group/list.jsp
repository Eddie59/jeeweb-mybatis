...
<grid:grid id="groupGridId" baseUrl="${adminPath}/sys/dict/group">
    ...
    <grid:button title="sys.dict.group.adddict" groupname="opt" function="rowDialogDetailRefresh" outclass="btn-primary"
                 innerclass="fa-plus" url="${adminPath}/sys/dict?gid=\"+row.id+\""/>
